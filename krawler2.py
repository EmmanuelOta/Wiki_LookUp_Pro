...
img = PhotoImage(file="Python/Krawler/asus.png")
canvas.pack(fill="both", expand=True)
canvas.create_image(0, 0, anchor="nw", image=img)

label_frame = LabelFrame(root, text="Krawler", width=70, bg="green", fg="black", font=("Consolas", 15))
label_frame1 = canvas.create_window(350, 10, anchor="n", window=label_frame)

search_bar = Entry(label_frame, width=70, bg="#363636", fg="#90EE90")
search_bar.pack()

text = Text(root,fg="#90EE90", bg="#363636", font=("Helvetica", 10))
